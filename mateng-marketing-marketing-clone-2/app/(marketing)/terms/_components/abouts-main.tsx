...
export function AboutsMain() {
  return (
    <div className="pt-20 pb-10 sm:pt-32 flex flex-col space-y-4">
      ...
      <div className="text-left text-base sm:text-lg w-[70%]">
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              <li>A final invoice is generated monthly, serving as the basis for all reconcilliations and refunds</li>
            </ul>
          </li>
          <li>
            <strong>Charges and Taxes</strong>
            <ul className="list-disc list-inside ml-4 space-y-2">
              <li>Deductions include Delivery/Return Chrages, COD Charges, Service Tax, and Fuel Surcharge. Entry Tax and OCTROI are manually deducted.</li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              <li>Do not use fraudulent means to access the Services or engage in disruptive or harmful behaviour.</li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              <li>Service are provided (as is) without warranties of any kind.</li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>If any provision is demand invalid, the remaining provisions will remain in effect.</li>
